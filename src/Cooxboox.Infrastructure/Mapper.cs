...
internal class Mapper
{
  ...
  private void MapPublishable(IPublishable source, IPublishableModel destination)
  {
    destination.Status = source.Status;
    destination.PublishedBy = TryGetActor(source.PublishedBy);
    destination.PublishedOn = source.PublishedOn?.AsUniversalTime();
  }
