...
public record SaveRecipeTypeLocalePayload
{
  ...
  public SaveRecipeTypeLocalePayload() : this(string.Empty)
  {
  }

  public SaveRecipeTypeLocalePayload(string name)
  {
    Name = name;
  }
  ...
  private class Validator : AbstractValidator<SaveRecipeTypeLocalePayload>
  {
    public Validator()
    {
