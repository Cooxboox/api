...
public record SaveIngredientTypeLocalePayload
{
  ...
  public SaveIngredientTypeLocalePayload() : this(string.Empty)
  {
  }

  public SaveIngredientTypeLocalePayload(string name)
  {
    Name = name;
  }
  ...
  private class Validator : AbstractValidator<SaveIngredientTypeLocalePayload>
  {
    public Validator()
    {
