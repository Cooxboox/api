...
public record SaveIngredientLocalePayload
{
  ...
  public SaveIngredientLocalePayload() : this(string.Empty)
  {
  }

  public SaveIngredientLocalePayload(string name)
  {
    Name = name;
  }
  ...
  private class Validator : AbstractValidator<SaveIngredientLocalePayload>
  {
    public Validator()
    {
