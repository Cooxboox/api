...
public record SaveIngredientCategoryLocalePayload
{
  ...
  public SaveIngredientCategoryLocalePayload() : this(string.Empty)
  {
  }

  public SaveIngredientCategoryLocalePayload(string name)
  {
    Name = name;
  }
  ...
  private class Validator : AbstractValidator<SaveIngredientCategoryLocalePayload>
  {
    public Validator()
    {
